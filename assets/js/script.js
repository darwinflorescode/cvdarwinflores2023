...
var smessage = "Dime, ¿Que intentas hacer? 🤷‍♀️🤷‍♂️ - 👮‍♂️";

function mensaje(sms) {
  let mensa = document.getElementById("mensaje");
  mensa.innerHTML = '<p class="alert alert-warning">' + sms + "</p>";
}
...
function disable_copy(e) {
  ...
  if (elemtype == "IMG" && checker_IMG == "checked" && e.detail >= 2) {
    mensaje(alertMsg_IMG);
    return false;
  }
  if (elemtype != "TEXT") {
    if (smessage !== "" && e.detail == 2) mensaje(smessage);
